...
public class LLSTG_UnknownSystem_Exception extends ListLabelException
  ...
  public LLSTG_UnknownSystem_Exception() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.LLSTG_UnknownSystem_Exception");
  ...
  public LLSTG_UnknownSystem_Exception(java.lang.String message) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.LLSTG_UnknownSystem_Exception", message);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public LLSTG_UnknownSystem_Exception(
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.LLSTG_UnknownSystem_Exception", message, innerException);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
