...
public class TableFieldBase extends TableField {
  ...
  public TableFieldBase(
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.Dom.TableFieldBase", objectType, itemCollection, index);
  ...
  public TableFieldBase(java.lang.String objectType, DomItem item) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.TableFieldBase", objectType, item);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
