...
public class SeparatedStringCollection extends Collection<java.lang.String>
  ...
  public SeparatedStringCollection(DomItem parent, java.lang.String propertyName) {
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.Dom.SeparatedStringCollection", parent, propertyName);
  ...
  public SeparatedStringCollection(
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel25.Dom.SeparatedStringCollection", parent, propertyName, separator);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
