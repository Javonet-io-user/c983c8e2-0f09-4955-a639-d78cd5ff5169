...
public class TableLineGroupHeader extends TableLineBase {
  ...
  public TableLineGroupHeader(CollectionTableLinesGroupHeader itemCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.TableLineGroupHeader", itemCollection);
  ...
  public TableLineGroupHeader(
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.Dom.TableLineGroupHeader", itemCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
