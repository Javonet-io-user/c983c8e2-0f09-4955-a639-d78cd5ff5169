...
public class PropertyLegendItem extends DomItem {
  ...
  public PropertyLegendItem(CollectionManualLegend collectionManualLegend) {
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.Dom.PropertyLegendItem", collectionManualLegend);
  ...
  public PropertyLegendItem(
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.Dom.PropertyLegendItem", collectionManualLegend, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
