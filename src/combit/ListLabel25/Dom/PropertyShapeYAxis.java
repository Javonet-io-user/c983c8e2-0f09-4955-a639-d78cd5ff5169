...
public class PropertyShapeYAxis extends DomItem {
  ...
  public PropertyShapeYAxis(CollectionPropertyShapeAxis collectionPropertyShapeAxis) {
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.Dom.PropertyShapeYAxis", collectionPropertyShapeAxis);
  ...
  public PropertyShapeYAxis(
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel25.Dom.PropertyShapeYAxis", collectionPropertyShapeAxis, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
