...
public class TableFieldHtml extends TableFieldBase {
  ...
  public TableFieldHtml(CollectionTableFieldBases itemCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.TableFieldHtml", itemCollection, index);
  ...
  public TableFieldHtml(CollectionTableFieldBases itemCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.TableFieldHtml", itemCollection);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
