...
public class PropertyValueAxisBase extends PropertyValueAxisBaseMinimal {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setFilterZeroes(java.lang.String value) {
    try {
      javonetHandle.set("FilterZeroes", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.String getFilterZeroes() {
    try {
      java.lang.String res = javonetHandle.get("FilterZeroes");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setNullValueHandling(java.lang.String value) {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.String getNullValueHandling() {
    try {
      java.lang.String res = javonetHandle.get("NullValueHandling");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
