...
public class ReportParameter extends DomItem implements IEquatable<ReportParameter> {
  ...
  public ReportParameter(CollectionReportParameters reportParametersCollection) {
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.Dom.ReportParameter", reportParametersCollection);
  ...
  public ReportParameter(
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.Dom.ReportParameter", reportParametersCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
