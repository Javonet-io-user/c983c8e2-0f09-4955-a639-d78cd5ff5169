...
public abstract class ProjectBase extends DomItem implements IDisposable {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Integer Replace(java.lang.String oldValue, java.lang.String newValue) {
    try {
      java.lang.Integer res = javonetHandle.invoke("Replace", oldValue, newValue);
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Integer Replace(
      java.lang.String oldValue, java.lang.String newValue, LlFindAndReplaceOptions options) {
    try {
      java.lang.Integer res =
          javonetHandle.invoke("Replace", oldValue, newValue, NEnum.fromJavaEnum(options));
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Integer Find(java.lang.String value) {
    try {
      java.lang.Integer res = javonetHandle.invoke("Find", value);
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Integer Find(java.lang.String value, LlFindAndReplaceOptions options) {
    try {
      java.lang.Integer res = javonetHandle.invoke("Find", value, NEnum.fromJavaEnum(options));
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  private java.util.ArrayList<EventHandler<ReplaceEventArgs>> _ReplaceHitListeners =
      new java.util.ArrayList<EventHandler<ReplaceEventArgs>>();

  public void addReplaceHit(EventHandler<ReplaceEventArgs> toAdd) {
    _ReplaceHitListeners.add(toAdd);
  }

  public void removeReplaceHit(EventHandler<ReplaceEventArgs> toRemove) {
    _ReplaceHitListeners.remove(toRemove);
  }
