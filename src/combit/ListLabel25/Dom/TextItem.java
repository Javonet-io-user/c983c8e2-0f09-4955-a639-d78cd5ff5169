...
public class TextItem extends DomItem {
  ...
  public TextItem(CollectionTextItems textRegionCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.TextItem", textRegionCollection);
  ...
  public TextItem(CollectionTextItems textRegionCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.TextItem", textRegionCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
