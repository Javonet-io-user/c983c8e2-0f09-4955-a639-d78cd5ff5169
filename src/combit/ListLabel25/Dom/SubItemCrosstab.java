...
public class SubItemCrosstab extends SubItemBase {
  ...
  public SubItemCrosstab(CollectionSubItemBases itemCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.SubItemCrosstab", itemCollection);
  ...
  public SubItemCrosstab(CollectionSubItemBases itemCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.SubItemCrosstab", itemCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
