...
public class RulerGuide extends DomItem {
  ...
  public RulerGuide(CollectionRulerGuides rulerGuideCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.RulerGuide", rulerGuideCollection);
  ...
  public RulerGuide(CollectionRulerGuides rulerGuideCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.RulerGuide", rulerGuideCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
