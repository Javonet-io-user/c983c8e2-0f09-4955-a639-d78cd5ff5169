...
public class CollectionVariable extends DomItem {
  ...
  public CollectionVariable(CollectionCollectionVariables collectionCollectionVariables) {
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.Dom.CollectionVariable", collectionCollectionVariables);
  ...
  public CollectionVariable(
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel25.Dom.CollectionVariable", collectionCollectionVariables, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
