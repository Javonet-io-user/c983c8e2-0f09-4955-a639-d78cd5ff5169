...
public class Paragraph extends DomItem {
  ...
  public Paragraph(CollectionParagraphs paragraphCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.Paragraph", paragraphCollection);
  ...
  public Paragraph(CollectionParagraphs paragraphCollection, java.lang.Integer index) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.Paragraph", paragraphCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
