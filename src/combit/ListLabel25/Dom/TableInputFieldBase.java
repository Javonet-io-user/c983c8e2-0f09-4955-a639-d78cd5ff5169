...
public class TableInputFieldBase extends TableField {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setUneditable(java.lang.String value) {
    try {
      javonetHandle.set("Uneditable", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.String getUneditable() {
    try {
      java.lang.String res = javonetHandle.get("Uneditable");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public TableInputFieldBase(
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel25.Dom.TableInputFieldBase", objectType, itemCollection, index);
  ...
  public TableInputFieldBase(java.lang.String objectType, DomItem item) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.TableInputFieldBase", objectType, item);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
