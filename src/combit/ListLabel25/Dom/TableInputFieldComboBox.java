...
public class TableInputFieldComboBox extends TableInputFieldBase {
  ...
  public TableInputFieldComboBox(CollectionTableFieldBases itemCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.TableInputFieldComboBox", itemCollection);
  ...
  public TableInputFieldComboBox(
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.Dom.TableInputFieldComboBox", itemCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
