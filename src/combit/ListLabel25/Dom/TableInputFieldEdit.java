...
public class TableInputFieldEdit extends TableInputFieldBase {
  ...
  public TableInputFieldEdit(CollectionTableFieldBases itemCollection) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.Dom.TableInputFieldEdit", itemCollection);
  ...
  public TableInputFieldEdit(CollectionTableFieldBases itemCollection, java.lang.Integer index) {
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.Dom.TableInputFieldEdit", itemCollection, index);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
