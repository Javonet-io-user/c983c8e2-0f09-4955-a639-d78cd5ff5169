...
public class DesignerFunctionParameter {
  ...
  public DesignerFunctionParameter() {
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.DesignerFunctionParameter");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public DesignerFunctionParameter(java.lang.String description) {
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.DesignerFunctionParameter", description);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
