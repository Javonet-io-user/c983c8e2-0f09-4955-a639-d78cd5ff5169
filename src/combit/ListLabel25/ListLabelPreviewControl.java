...
public class ListLabelPreviewControl extends Control
  ...
  public ListLabelPreviewControl(IContainer container) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.ListLabelPreviewControl", container);
  ...
  public ListLabelPreviewControl() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.ListLabelPreviewControl");
      super.construct(javonetHandle);
      javonetHandle.addEventListener(
          "PageChanged",
          new com.javonet.api.INEventListener() {
  ...
  public ListLabelPreviewControl(ILlLogger logger) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.ListLabelPreviewControl", logger);
      super.construct(javonetHandle);
      javonetHandle.addEventListener(
          "PageChanged",
          new com.javonet.api.INEventListener() {
  ...
  public static class PreviewZoomStyle {
    ...
    public PreviewZoomStyle(ListLabelPreviewControl parentPreviewControl) {
      try {
        javonetHandle =
            Javonet.New(
                "combit.ListLabel25.ListLabelPreviewControl+PreviewZoomStyle",
  ...
  public static class PreviewPageStyle {
    ...
    public PreviewPageStyle(ListLabelPreviewControl parentPreviewControl) {
      try {
        javonetHandle =
            Javonet.New(
                "combit.ListLabel25.ListLabelPreviewControl+PreviewPageStyle",
                parentPreviewControl);
      } catch (JavonetException _javonetException) {
        _javonetException.printStackTrace();
      }
  ...
  public static class PreviewSelectionFrame {
    ...
    public PreviewSelectionFrame(ListLabelPreviewControl parentPreviewControl) {
      try {
        javonetHandle =
            Javonet.New(
                "combit.ListLabel25.ListLabelPreviewControl+PreviewSelectionFrame",
                parentPreviewControl);
      } catch (JavonetException _javonetException) {
        _javonetException.printStackTrace();
      }
  ...
  public static class PageChangedEventArgs extends EventArgs {
    ...
    public PageChangedEventArgs() {
      ...
      try {
        javonetHandle =
            Javonet.New("combit.ListLabel25.ListLabelPreviewControl+PageChangedEventArgs");
  ...
  public static class ButtonPressEventArgs extends EventArgs {
    ...
    public ButtonPressEventArgs() {
      ...
      try {
        javonetHandle =
            Javonet.New("combit.ListLabel25.ListLabelPreviewControl+ButtonPressEventArgs");
        super.setJavonetHandle(javonetHandle);
      } catch (JavonetException _javonetException) {
        _javonetException.printStackTrace();
      }
  ...
  public static class LoadFinishedEventArgs extends EventArgs {
    ...
    public LoadFinishedEventArgs() {
      ...
      try {
        javonetHandle =
            Javonet.New("combit.ListLabel25.ListLabelPreviewControl+LoadFinishedEventArgs");
        super.setJavonetHandle(javonetHandle);
      } catch (JavonetException _javonetException) {
        _javonetException.printStackTrace();
      }
