...
public class LLSTG_AccessDenied_Exception extends ListLabelException
  ...
  public LLSTG_AccessDenied_Exception() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.LLSTG_AccessDenied_Exception");
  ...
  public LLSTG_AccessDenied_Exception(java.lang.String message) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.LLSTG_AccessDenied_Exception", message);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public LLSTG_AccessDenied_Exception(
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.LLSTG_AccessDenied_Exception", message, innerException);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
