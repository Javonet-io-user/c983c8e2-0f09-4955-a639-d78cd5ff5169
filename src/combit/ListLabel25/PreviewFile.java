...
public class PreviewFile implements ICollection, IEnumerable, IDisposable, Iterable<Object> {
  ...
  public PreviewFile(java.lang.String filename) {
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.PreviewFile", filename);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public PreviewFile(java.lang.String filename, java.lang.Boolean readOnly) {
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.PreviewFile", filename, readOnly);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public PreviewFile(
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel25.PreviewFile",
              filename,
              readOnly,
              tempPath,
  ...
  public PreviewFile(IntPtr handle) {
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.PreviewFile", handle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
