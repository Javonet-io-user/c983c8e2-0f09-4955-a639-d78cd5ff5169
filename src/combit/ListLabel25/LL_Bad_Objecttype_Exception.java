...
public class LL_Bad_Objecttype_Exception extends ListLabelException
  ...
  public LL_Bad_Objecttype_Exception() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.LL_Bad_Objecttype_Exception");
  ...
  public LL_Bad_Objecttype_Exception(java.lang.String message) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.LL_Bad_Objecttype_Exception", message);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public LL_Bad_Objecttype_Exception(
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.LL_Bad_Objecttype_Exception", message, innerException);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
