...
public class AdoDataProvider implements IDataProvider, IDisposable, ICanHandleUsedIdentifiers {
  ...
  public AdoDataProvider(DataView dataView) {
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.DataProviders.AdoDataProvider", dataView);
  ...
  public AdoDataProvider(DataTable dataTable) {
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.DataProviders.AdoDataProvider", dataTable);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public AdoDataProvider(DataViewManager dataViewManager) {
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.DataProviders.AdoDataProvider", dataViewManager);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public AdoDataProvider(DataSet dataSet) {
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.DataProviders.AdoDataProvider", dataSet);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
