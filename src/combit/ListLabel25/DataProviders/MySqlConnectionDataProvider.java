...
public class MySqlConnectionDataProvider extends DbConnectionDataProvider
  ...
  public MySqlConnectionDataProvider(IDbConnection connection) {
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.DataProviders.MySqlConnectionDataProvider", connection);
  ...
  public MySqlConnectionDataProvider(java.lang.String connectionString) {
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel25.DataProviders.MySqlConnectionDataProvider", connectionString);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
