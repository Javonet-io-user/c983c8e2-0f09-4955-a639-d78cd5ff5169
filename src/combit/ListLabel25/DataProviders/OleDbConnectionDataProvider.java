...
public class OleDbConnectionDataProvider extends DbConnectionDataProvider
  ...
  public OleDbConnectionDataProvider() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.DataProviders.OleDbConnectionDataProvider");
  ...
  public OleDbConnectionDataProvider(OleDbConnection connection) {
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.DataProviders.OleDbConnectionDataProvider", connection);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public OleDbConnectionDataProvider(
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel25.DataProviders.OleDbConnectionDataProvider",
              connection,
