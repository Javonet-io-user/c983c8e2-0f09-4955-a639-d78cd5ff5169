...
public class OracleConnectionDataProvider extends DbConnectionDataProvider
  ...
  public OracleConnectionDataProvider(java.lang.String connectionString) {
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel25.DataProviders.OracleConnectionDataProvider", connectionString);
  ...
  public OracleConnectionDataProvider(
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel25.DataProviders.OracleConnectionDataProvider",
              connectionString,
              tableOwner);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
  ...
  public static DbProviderFactory GetOracleConnectionFactory() {
    try {
      Object res =
          Javonet.getType("combit.ListLabel25.DataProviders.OracleConnectionDataProvider")
