...
public class GraphQLObject {
  ...
  public List<GraphQLQuery> getQueries() {
    try {
      Object res = javonetHandle.<NObject>get("Queries");
      if (res == null) return null;
      return new List<GraphQLQuery>((NObject) res);
  ...
  public void setPrimaryKey(java.lang.String value) {
    try {
      javonetHandle.set("PrimaryKey", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getPrimaryKey() {
    try {
      java.lang.String res = javonetHandle.get("PrimaryKey");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  @MethodTypeAnnotation(type = "GetField")
  public List<java.lang.String> getBinaryColumns() {
    try {
      Object res = javonetHandle.<NObject>get("BinaryColumns");
      if (res == null) return null;
  ...
  public GraphQLObject() {
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.DataProviders.GraphQLObject");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public GraphQLObject(NObject handle) {
