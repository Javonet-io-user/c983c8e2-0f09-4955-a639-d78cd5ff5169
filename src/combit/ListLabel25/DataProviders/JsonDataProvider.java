...
public class JsonDataProvider implements IDataProvider, ISerializable, ISupportsParameters {
  ...
  public JsonDataProvider(java.lang.String json) {
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.DataProviders.JsonDataProvider", json);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public JsonDataProvider(TextReader reader) {
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.DataProviders.JsonDataProvider", reader);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public JsonDataProvider(java.lang.String filePathOrUrl, JsonDataProviderOptions options) {
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.DataProviders.JsonDataProvider", filePathOrUrl, options);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
