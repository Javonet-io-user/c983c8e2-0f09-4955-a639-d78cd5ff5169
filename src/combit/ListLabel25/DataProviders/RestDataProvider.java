...
public class RestDataProvider implements IDataProvider, ISupportsLogger, ISupportsParameters {
  ...
  public static java.lang.Integer getdefaultTimeout() {
    try {
      java.lang.Integer res =
          Javonet.getType("combit.ListLabel25.DataProviders.RestDataProvider")
              .get("defaultTimeout");
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
  ...
  public RestDataProvider(java.lang.String url) {
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.DataProviders.RestDataProvider", url);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public RestDataProvider(
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel25.DataProviders.RestDataProvider", url, username, password, domain);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
