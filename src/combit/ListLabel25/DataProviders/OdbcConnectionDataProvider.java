...
public class OdbcConnectionDataProvider extends DbConnectionDataProvider
  ...
  public OdbcConnectionDataProvider(OdbcConnection connection) {
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.DataProviders.OdbcConnectionDataProvider", connection);
  ...
  public OdbcConnectionDataProvider(
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel25.DataProviders.OdbcConnectionDataProvider",
              connection,
  ...
  public static class AddRelationEventArgs extends EventArgs {
    ...
    public AddRelationEventArgs() {
      ...
      try {
        javonetHandle =
            Javonet.New(
                "combit.ListLabel25.DataProviders.OdbcConnectionDataProvider+AddRelationEventArgs");
        super.setJavonetHandle(javonetHandle);
      } catch (JavonetException _javonetException) {
        _javonetException.printStackTrace();
      }
