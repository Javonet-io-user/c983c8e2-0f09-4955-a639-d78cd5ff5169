...
public class SQLiteConnectionDataProvider extends DbConnectionDataProvider
  ...
  public SQLiteConnectionDataProvider(IDbConnection connection) {
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.DataProviders.SQLiteConnectionDataProvider", connection);
  ...
  public SQLiteConnectionDataProvider(java.lang.String connectionString) {
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel25.DataProviders.SQLiteConnectionDataProvider", connectionString);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
