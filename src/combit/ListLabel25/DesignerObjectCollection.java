...
public class DesignerObjectCollection extends CollectionBase
  ...
  public void setItem(java.lang.Integer index, DesignerObject value) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public DesignerObject getItem(java.lang.Integer index) {
    try {
  ...
  public DesignerObjectCollection() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.DesignerObjectCollection");
  ...
  public static class DesignerObjectEnumerator implements IEnumerator, Iterator<Object> {
    ...
    public DesignerObjectEnumerator(DesignerObjectCollection mappings) {
      try {
        javonetHandle =
            Javonet.New(
                "combit.ListLabel25.DesignerObjectCollection+DesignerObjectEnumerator", mappings);
      } catch (JavonetException _javonetException) {
        _javonetException.printStackTrace();
      }
    }
