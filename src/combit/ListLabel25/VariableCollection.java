...
public class VariableCollection extends ElementBaseCollection
  ...
  public VariableCollection(ListLabel ll) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.VariableCollection", ll);
  ...
  public void AddUserObject(
      java.lang.String name, java.lang.String value, java.lang.Boolean withDialog) {
    try {
      javonetHandle.invoke("AddUserObject", name, value, withDialog);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public void AddUserObject(
      ...
      DrawUserObjectHandler drawHandler,
      EditUserObjectHandler dialogHandler) {
    try {
      javonetHandle.invoke("AddUserObject", name, value, drawHandler, dialogHandler);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
