...
public class ComStreamWrapper extends Stream implements IDisposable {
  ...
  public ComStreamWrapper(IStream stream) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.ComStreamWrapper", stream);
  ...
  public ComStreamWrapper(IntPtr nativeComStreamPointer) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.ComStreamWrapper", nativeComStreamPointer);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
