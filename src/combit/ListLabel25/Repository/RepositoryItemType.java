package combit.ListLabel25.Repository;
...
public class RepositoryItemType {
  ...
  public static RepositoryItemType getImage() {
    try {
      Object res =
          Javonet.getType("combit.ListLabel25.Repository.RepositoryItemType").<NObject>get("Image");
  ...
  public static void setImage(RepositoryItemType param) {
    try {
      Javonet.getType("combit.ListLabel25.Repository.RepositoryItemType").set("Image", param);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public static RepositoryItemType getPDF() {
    try {
      Object res =
          Javonet.getType("combit.ListLabel25.Repository.RepositoryItemType").<NObject>get("PDF");
      if (res == null) return null;
      return new RepositoryItemType((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public static void setPDF(RepositoryItemType param) {
    try {
      Javonet.getType("combit.ListLabel25.Repository.RepositoryItemType").set("PDF", param);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public static RepositoryItemType getProjectList() {
    try {
      Object res =
          Javonet.getType("combit.ListLabel25.Repository.RepositoryItemType")
  ...
  public static void setProjectList(RepositoryItemType param) {
    try {
      Javonet.getType("combit.ListLabel25.Repository.RepositoryItemType").set("ProjectList", param);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public static void setProjectCard(RepositoryItemType param) {
    try {
      Javonet.getType("combit.ListLabel25.Repository.RepositoryItemType").set("ProjectCard", param);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public static void setSketchImage(RepositoryItemType param) {
    try {
      Javonet.getType("combit.ListLabel25.Repository.RepositoryItemType").set("SketchImage", param);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public static void setShapefile(RepositoryItemType param) {
    try {
      Javonet.getType("combit.ListLabel25.Repository.RepositoryItemType").set("Shapefile", param);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
