...
public class DEVMODE {
  ...
  public static java.lang.Integer getTStrSize() {
    try {
      java.lang.Integer res = Javonet.getType("combit.ListLabel25.DEVMODE").get("TStrSize");
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public static void setTStrSize(java.lang.Integer param) {
    try {
      Javonet.getType("combit.ListLabel25.DEVMODE").set("TStrSize", param);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public DEVMODE() {
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.DEVMODE");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
