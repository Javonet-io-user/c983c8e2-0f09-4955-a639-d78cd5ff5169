...
public class LlToolbar extends ValueType {
  ...
  public IntPtr gethWnd() {
    try {
      Object res = javonetHandle.<NObject>get("hWnd");
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void sethWnd(IntPtr param) {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public IntPtr gethMenu() {
    try {
      Object res = javonetHandle.<NObject>get("hMenu");
      if (res == null) return null;
      return (jio.System.IntPtr) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void sethMenu(IntPtr param) {
    try {
