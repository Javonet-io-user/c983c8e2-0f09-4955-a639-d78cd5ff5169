...
public class DesignerObject extends Component
  ...
  public DesignerObject() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.DesignerObject");
      ...
      javonetHandle.addEventListener(
          "ObjectPropertiesLoaded",
          new com.javonet.api.INEventListener() {
            @Override
            public void eventOccurred(Object[] objects) {
              for (EventHandler<EventArgs> handler : _ObjectPropertiesLoadedListeners) {
                handler.Invoke(
                    Convert(objects[0], Object.class), Convert(objects[1], EventArgs.class));
              }
            }
  ...
  public java.lang.Integer SetLLJob(java.lang.Integer hLLJob, java.lang.Integer pLLBase) {
    try {
      java.lang.Integer res =
          javonetHandle
              .explicitInterface("combit.ListLabel25.DesignerExtensions.IDesignerObject")
      ...
      java.lang.Integer res =
          javonetHandle
              ...
              .invoke(
                  ...
                  nProjType,
                  new NOut(
                      pbSupported, JavonetHelper.JavaToDotnetType.get(java.lang.Boolean.class)));
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.Integer GetOption(java.lang.Integer nOption, IntPtr pnValue) {
    try {
      java.lang.Integer res =
          javonetHandle
              .explicitInterface("combit.ListLabel25.DesignerExtensions.IDesignerObject")
              .invoke("GetOption", nOption, pnValue);
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      ...
      java.lang.Integer res =
          javonetHandle
              ...
              .invoke(
                  "GetOptionString",
                  sOption,
                  new NOut(psText, JavonetHelper.JavaToDotnetType.get(java.lang.String.class)));
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.Integer OnMouseMove(IntPtr hDC, PointInt ptMouse, IntPtr phCrs) {
    try {
      java.lang.Integer res =
          javonetHandle
              .explicitInterface("combit.ListLabel25.DesignerExtensions.IDesignerObject")
              .invoke("OnMouseMove", hDC, ptMouse, phCrs);
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.Integer Next(
    ...
    try {
      java.lang.Integer res =
          javonetHandle
              .explicitInterface("combit.ListLabel25.DesignerExtensions.IPropertyEnumeration")
              .invoke(
                  "Next",
                  size,
                  property,
  ...
  private java.util.ArrayList<EventHandler<EventArgs>> _ObjectPropertiesLoadedListeners =
      new java.util.ArrayList<EventHandler<EventArgs>>();

  public void addObjectPropertiesLoaded(EventHandler<EventArgs> toAdd) {
    _ObjectPropertiesLoadedListeners.add(toAdd);
  }

  public void removeObjectPropertiesLoaded(EventHandler<EventArgs> toRemove) {
    _ObjectPropertiesLoadedListeners.remove(toRemove);
  }
