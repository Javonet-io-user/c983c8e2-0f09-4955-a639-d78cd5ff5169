...
public class ListLabelIdenticalTableNamesException extends ListLabelException
  ...
  public ListLabelIdenticalTableNamesException(java.lang.String tableName) {
    ...
    try {
      javonetHandle =
          Javonet.New("combit.ListLabel25.ListLabelIdenticalTableNamesException", tableName);
  ...
  public ListLabelIdenticalTableNamesException() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("combit.ListLabel25.ListLabelIdenticalTableNamesException");
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public ListLabelIdenticalTableNamesException(
    ...
    try {
      javonetHandle =
          Javonet.New(
              "combit.ListLabel25.ListLabelIdenticalTableNamesException", message, innerException);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
